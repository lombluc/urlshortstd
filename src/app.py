...
class URLHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        if self.path == "/shorten":
            ...
            if "url" in post_data:
                shortened_url = self.url_shortener.shorten_url(post_data.get("url", ""))
